...
create function [dbo].[fnPaidOutTrxTable1]
(
	@BeginDate datetime,
	@EndDate datetime
)
...
begin
	...
	FROM paidOutTrx where [BusinessDate] between @historyDate and @EndDate  

	INSERT INTO @resultTable([StoreID],[ID],[Amount],[ManagerID],[EmployeeID],[Note],[Status],[BusinessDate],[LastUpdate])
	SELECT [StoreID],[ID],[Amount],[ManagerID],[EmployeeID],[Note],[Status],[BusinessDate],[LastUpdate]
	FROM paidOutTrxArchive where [BusinessDate] between @BeginDate and @historyDate 
...
begin
	INSERT INTO @resultTable([StoreID],[ID],[Amount],[ManagerID],[EmployeeID],[Note],[Status],[BusinessDate],[LastUpdate])
	SELECT [StoreID],[ID],[Amount],[ManagerID],[EmployeeID],[Note],[Status],[BusinessDate],[LastUpdate]
	FROM paidOutTrx where [BusinessDate] between @BeginDate and @EndDate 
end
else if (@EndDate<@historyDate)
begin
	INSERT INTO @resultTable([StoreID],[ID],[Amount],[ManagerID],[EmployeeID],[Note],[Status],[BusinessDate],[LastUpdate])
	SELECT [StoreID],[ID],[Amount],[ManagerID],[EmployeeID],[Note],[Status],[BusinessDate],[LastUpdate]
	FROM paidOutTrxArchive where [BusinessDate] between @BeginDate and @EndDate 
end

...
CREATE Procedure [dbo].[Rpt_D_NumberByPaymentTypeAll]
	@BeginDate datetime,	
	@EndDate datetime,
...
set @sql+=' GROUP BY pm.Name '+@groupBySql+')a pivot (sum(numPayments) for PaymentName in('+@colName+')) b order by periodID'

...
SET ANSI_NULLS ON
GO
CREATE Procedure [dbo].[Rpt_D_NumTableByPeriodByDay]
	@BeginDate datetime,
	@EndDate datetime,
...
set @sql='Select o1.dayPart MealPriod,
	...
	where o1.BusinessDate between '''+CONVERT(nvarchar(20),@BeginDate)+''' 
	and '''+CONVERT(nvarchar(20),@EndDate)+''' and o1.StoreID in ('+@storeID+')
	and o1.Status=''CLOSE'''

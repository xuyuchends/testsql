...
SET ANSI_NULLS ON
GO
CREATE Procedure [dbo].[Rpt_D_CompByStoreByDay]
	@BeginDate datetime,
	@EndDate datetime,
...
set @sql='
 SELECT s.storeName as StoreName ,SUM(isnull(CASE OI.RecordType WHEN ''COMP'' THEN OI.qty * OI.AdjustedPrice END,0)) as Comp 

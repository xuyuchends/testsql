CREATE TABLE [dbo].[GoogleChartLaborByStore]
(
...
GO
ALTER TABLE [dbo].[GoogleChartLaborByStore] ADD CONSTRAINT [PK_GoogleChartSalesAndLabor] PRIMARY KEY CLUSTERED  ([StoreID], [Period], [BusinessDate], [Type]) ON [PRIMARY]
GO

CREATE TABLE [dbo].[CDM_Transfer_tblMENU_ITEMS]
(
...
[TransferState] [int] NOT NULL CONSTRAINT [DF_CDM_tblMENU_ITEMS_Transfer_TransferState] DEFAULT ((1))
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
ALTER TABLE [dbo].[CDM_Transfer_tblMENU_ITEMS] ADD CONSTRAINT [PK_CDM_Transfer_tblMENU_ITEMS] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO

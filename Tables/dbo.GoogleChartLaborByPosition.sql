CREATE TABLE [dbo].[GoogleChartLaborByPosition]
(
...
GO
ALTER TABLE [dbo].[GoogleChartLaborByPosition] ADD CONSTRAINT [PK_GoogleChartSalesByPosition] PRIMARY KEY CLUSTERED  ([StoreID], [PositionName], [Period], [BusinessDate], [Type]) ON [PRIMARY]
GO
